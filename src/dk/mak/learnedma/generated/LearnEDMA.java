package dk.mak.learnedma.generated;
...
public class LearnEDMA
{
    ...
    public static IMetaEnvironment generateEnvironment()
    {
        ...
        //String value domain: MyString
        {
            ArrayList<Constraint> edma_constraints = null;
            vdb.newStringDomain("MyString", null, 1, null, null, edma_constraints, false);
        }
        
        //Integer value domain: MyInteger
        {
            ArrayList<Constraint> edma_constraints = null;
            vdb.newIntegerDomain("MyInteger", null, null, null, edma_constraints, false);
        }
        
        //Boolean value domain: MyBoolean
        {
            ArrayList<Constraint> edma_constraints = null;
            vdb.newBooleanDomain("MyBoolean", null, edma_constraints, false);
        }
        
        //OneOf value domain: MyValue
        {
            ArrayList<Constraint> edma_constraints = null;
            Collection<String> optionDomains = new ArrayList<String>(5);
            optionDomains.add("MyString");
            optionDomains.add("MyInteger");
            optionDomains.add("MyBoolean");
            optionDomains.add("MyArray");
            optionDomains.add("MyObject");
            vdb.newOneOfDomain("MyValue", null, optionDomains, edma_constraints, false);
        }
        
        //List value domain: MyObject
        {
            ArrayList<Constraint> edma_constraints = null;
            vdb.newListDomain("MyObject", null, "Pair", null, null, edma_constraints, false);
        }
        ...
        //Struct value domain: Pair
        {
            ...
            fields.add(vdb.newStructField("key", "MyString", false));
            fields.add(vdb.newStructField("value", "MyValue", false));
            vdb.newStructDomain("Pair", null, fields, edma_constraints, false);
        }
        
        //List value domain: MyArray
        {
            ArrayList<Constraint> edma_constraints = null;
            vdb.newListDomain("MyArray", null, "MyObject", null, null, edma_constraints, false);
        }
        ...
        //Struct value domain: Json
        {
            ArrayList<Constraint> edma_constraints = null;
            Collection<Field> fields = new ArrayList<Field>();
            fields.add(vdb.newStructField("pair", "Pair", true));
        ...
        //Enum value domain: WetsuitSize
        {
            ...
            elements.add("XL");
            elements.add("XXL");
            vdb.newEnumDomain("WetsuitSize", null, elements, edma_constraints, false);
        }
        ...
        //List value domain: WetsuitSizeList
        {
            ArrayList<Constraint> edma_constraints = null;
            vdb.newListDomain("WetsuitSizeList", null, "WetsuitSize", 3, 5, edma_constraints, false);
        }
        
        //String value domain: Food
        {
            ArrayList<Constraint> edma_constraints = null;
            vdb.newStringDomain("Food", null, 1, 32, null, edma_constraints, false);
        }
        
        //Struct value domain: Dog
        {
            ArrayList<Constraint> edma_constraints = null;
            Collection<Field> fields = new ArrayList<Field>();
            fields.add(vdb.newStructField("name", "Name", false));
            fields.add(vdb.newStructField("food", "Food", false));
            vdb.newStructDomain("Dog", null, fields, edma_constraints, false);
        }
        
        //Struct value domain: Cat
        {
            ArrayList<Constraint> edma_constraints = null;
            Collection<Field> fields = new ArrayList<Field>();
            fields.add(vdb.newStructField("name", "Name", false));
            fields.add(vdb.newStructField("lifeCount", "NotNegInt", false));
            vdb.newStructDomain("Cat", null, fields, edma_constraints, false);
        }
        ...
        //Struct value domain: Bird
        {
            ...
            Collection<Field> fields = new ArrayList<Field>();
            fields.add(vdb.newStructField("name", "Name", false));
            fields.add(vdb.newStructField("numberOfWings", "PosInt", false));
            vdb.newStructDomain("Bird", null, fields, edma_constraints, false);
        }
        
        //OneOf value domain: Animal
        {
            ArrayList<Constraint> edma_constraints = null;
            Collection<String> optionDomains = new ArrayList<String>(3);
            optionDomains.add("Dog");
            optionDomains.add("Cat");
            optionDomains.add("Bird");
            vdb.newOneOfDomain("Animal", null, optionDomains, edma_constraints, false);
        }
