 ...
 */
public class CatImpl extends Cat implements IValueInstance
{
    ...
    /**
     * Compare this Cat to another Cat
     * @param cat  The Cat to compare with
     * @return     A negative integer, zero, or a positive integer as this Cat
     *             is less than, equal to, or greater than the specified Cat
     */
    public int compareTo(Cat cat)
    {
        return edma_domain.valueCompare(value, ((CatImpl) cat).value);
    }
     ...
     */
    public NotNegInt lifeCount()
    {
        return new NotNegIntImpl(value[1]);
    }
}
