 ...
 */
public class DogImpl extends Dog implements IValueInstance
{
    ...
    /**
     * Compare this Dog to another Dog
     * @param dog  The Dog to compare with
     * @return     A negative integer, zero, or a positive integer as this Dog
     *             is less than, equal to, or greater than the specified Dog
     */
    public int compareTo(Dog dog)
    {
        return edma_domain.valueCompare(value, ((DogImpl) dog).value);
    }
