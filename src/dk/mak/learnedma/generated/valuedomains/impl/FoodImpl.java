 ...
 */
public class FoodImpl extends Food implements IValueInstance
{
    ...
    /**
     * Compare this Food to another Food
     * @param food  The Food to compare with
     * @return      A negative integer, zero, or a positive integer as this
     *              Food is less than, equal to, or greater than the specified
     *              Food
     */
    public int compareTo(Food food)
    {
        return edma_domain.valueCompare(value, ((FoodImpl) food).value);
    }
