...
/**
 * The implementation of MyArray
 */
public class MyArrayImpl extends MyArray implements IValueInstance
{
    ...
    /**
     * Compare this MyArray to another MyArray
     * @param myArray  The MyArray to compare with
     * @return         A negative integer, zero, or a positive integer as this
     *                 MyArray is less than, equal to, or greater than the
     *                 specified MyArray
     */
    public int compareTo(MyArray myArray)
    {
        return edma_domain.valueCompare(value, ((MyArrayImpl) myArray).value);
    }
    ...
    {
        return new MyObjectImpl(value[index]);
    }
     ...
     * 
     */
    public class MyArrayIterator implements Iterator<MyObject>
    {
        private int pos;
        ...
        {
            return new MyObjectImpl(value[pos++]);
        }
