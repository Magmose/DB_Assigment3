...
/**
 * The implementation of MyBoolean
 */
public class MyBooleanImpl extends MyBoolean implements IValueInstance
{
     ...
     */
    public MyBooleanImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this MyBoolean to another MyBoolean
     * @param myBoolean  The MyBoolean to compare with
     * @return           A negative integer, zero, or a positive integer as
     *                   this MyBoolean is less than, equal to, or greater than
     *                   the specified MyBoolean
     */
    public int compareTo(MyBoolean myBoolean)
    {
        return edma_domain.valueCompare(value, ((MyBooleanImpl) myBoolean).value);
    }
