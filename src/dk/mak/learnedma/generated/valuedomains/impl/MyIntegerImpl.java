...
/**
 * The implementation of MyInteger
 */
public class MyIntegerImpl extends MyInteger implements IValueInstance
{
     ...
     */
    public MyIntegerImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this MyInteger to another MyInteger
     * @param myInteger  The MyInteger to compare with
     * @return           A negative integer, zero, or a positive integer as
     *                   this MyInteger is less than, equal to, or greater than
     *                   the specified MyInteger
     */
    public int compareTo(MyInteger myInteger)
    {
        return edma_domain.valueCompare(value, ((MyIntegerImpl) myInteger).value);
    }
