 ...
 */
public class PairImpl extends Pair implements IValueInstance
{
    ...
    /**
     * Compare this Pair to another Pair
     * @param pair  The Pair to compare with
     * @return      A negative integer, zero, or a positive integer as this
     *              Pair is less than, equal to, or greater than the specified
     *              Pair
     */
    public int compareTo(Pair pair)
    {
        return edma_domain.valueCompare(value, ((PairImpl) pair).value);
    }
    ...
    public MyString key()
    {
        return new MyStringImpl(value[0]);
    }
    ...
    {
        return new MyValueImpl(value[1]);
    }
}
