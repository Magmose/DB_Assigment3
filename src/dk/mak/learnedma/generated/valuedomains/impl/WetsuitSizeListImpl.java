...
/**
 * The implementation of WetsuitSizeList
 */
public class WetsuitSizeListImpl extends WetsuitSizeList implements IValueInstance
{
     ...
     */
    public WetsuitSizeListImpl(Object o)
    {
        edma_hash = 0;
        value = (Object[]) o;
    }
    ...
    /**
     * Compare this WetsuitSizeList to another WetsuitSizeList
     * @param wetsuitSizeList  The WetsuitSizeList to compare with
     * @return                 A negative integer, zero, or a positive integer
     *                         as this WetsuitSizeList is less than, equal to,
     *                         or greater than the specified WetsuitSizeList
     */
    public int compareTo(WetsuitSizeList wetsuitSizeList)
    {
        return edma_domain.valueCompare(value, ((WetsuitSizeListImpl) wetsuitSizeList).value);
    }
     ...
     */
    public Iterator<WetsuitSize> iterator()
    {
        return new WetsuitSizeListIterator();
    }
     ...
     */
    public WetsuitSize get(int index)
    {
        return new WetsuitSizeImpl(value[index]);
    }
     ...
     * 
     */
    public class WetsuitSizeListIterator implements Iterator<WetsuitSize>
    {
        private int pos;
         ...
         * Constructor
         */
        public WetsuitSizeListIterator()
        {
            pos = 0;
        }
         ...
         */
        public WetsuitSize next()
        {
            return new WetsuitSizeImpl(value[pos++]);
        }
